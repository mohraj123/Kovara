Kōvara
A decentralized, community-verified cost-of-living oracle built on the Stellar Network. Submit local prices for bread, rent, transport, and utilities. Peers cross-verify on-chain. The output: a daily, tamper-evident, country-by-country purchasing-power index — incentivized entirely with XLM and Stellar USDC micro-rewards.

License: MIT Network: Stellar Contracts: Soroban Monorepo: pnpm Build: Turborepo
...
A funded Stellar Testnet account — get one via Stellar Laboratory
Quickstart
...
See CONTRIBUTING.md for guidelines and docs/architecture.md for a full system deep-dive.

Good first issues: label:good-first-issue

Security
Smart contracts audited by [TBD] — reports in audits/
...
Built on Stellar · Powered by Soroban · Open data for the world 🌍
